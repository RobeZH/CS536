...
public class P1Sample {
     ...
     * and WrongArgumentExceptions under the correct conditions.
     * <p>
     * Also tests:
    ...
    private static void testExceptions() {
        ...
        // test addDecl throws WrongArgumentException
        symTab = new SymTable();
        try {
            symTab.addDecl(null, new Sym("type"));
            error("SymTable.addDecl",
                    "WrongArgumentException NOT thrown on addDecl(null, sym)");
        ...
        try {
            ...
            error("SymTable.addDecl",
                    "WrongArgumentException NOT thrown on addDecl(name, null)");
        } catch (WrongArgumentException e) {
            // expected
        } catch (Exception e) {
            error("SymTable.addDecl",
        ...
        try {
            ...
            error("SymTable.addDecl",
                    "WrongArgumentException NOT thrown on addDecl(null, null)");
        } catch (WrongArgumentException e) {
            // expected
        } catch (Exception e) {
            error("SymTable.addDecl",
